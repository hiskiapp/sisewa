...
@section('title', 'Data User: ' . $user->name)
@section('content')
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">
                Data User:  {{ $user->name }}<i class="mr-2"></i>
            </h3>
        </div>
    ...
    <div class="card-body">
        <!--begin::Form-->
        <form class="form" id="kt_form" method="POST" action="{{ route('admin.users.data', $user->id) }}" enctype="multipart/form-data">
            @csrf
